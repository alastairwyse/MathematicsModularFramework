...
{
    /// <summary>
    /// A test module with 2 inputs and 2 outputs.
    /// </summary>
    public class Module2_2 : ModuleBase
    {
        public Module2_2()
            : base()
        {
            Description = "Module with 2 inputs and 2 outputs";
            AddInputSlot("Input1", "The first input slot", typeof(Int32));
            AddInputSlot("Input2", "The second input slot", typeof(Int32));
        ...
        protected override void ImplementProcess()
        {
            ...
            GetOutputSlot("Output2").DataValue = GetInputSlot("Input2").DataValue;
        }
    }
}
